...
/**
  ...
  * number of days.
  */
case class AlwaysCrossingUpMovingAverageCalculatorStub(numberOfDaysThatIsAlwaysCrossingAnotherMovingAverage: Int) extends MovingAverageCalculator {

  val CURRENT_MOVING_AVERAGE_THAT_IS_CROSSING: BigDecimal = 10

  val CURRENT_MOVING_AVERAGE_BEING_CROSSED: BigDecimal = 5
