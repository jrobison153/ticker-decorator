...
/**
  ...
  */
case class PreviouslyCrossedDownMovingAverageCalculatorStub(numberOfDaysThatIsAlwaysCrossingAnotherMovingAverage: Int)
  extends MovingAverageCalculator {

  val CURRENT_MOVING_AVERAGE_THAT_IS_CROSSING: BigDecimal = 5
